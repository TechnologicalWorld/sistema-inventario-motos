...
export async function getCompras(params: {
  ...
  const res = await api.get("/propietario/compras", { params: queryParams });
  const json = res.data;
...
export async function getCompraById(idCompra: number): Promise<Compra> {
  const res = await api.get(`/propietario/compras/${idCompra}`);
  const json = res.data;
...
export async function createCompra(
  ...
  const res = await api.post("/propietario/compras", payload);
  const json = res.data;
...
export async function fetchProveedoresOptions(): Promise<ProveedorOption[]> {
  try {
    const res = await api.get("/propietario/proveedores");
    const json = res.data;
...
export async function fetchProductosOptions(): Promise<ProductoOption[]> {
  try {
    const res = await api.get("/propietario/inventario/productos");
    const json = res.data;
